...
describe("session launch contract", () => {
  ...
  it("wires ready, preparing, and guided spatial preview states into the existing session shell", () => {
    ...
    expect(launchView).toContain("Guidage IA");
    expect(launchView).not.toContain("Séance prête");
    expect(launchView).toContain("Vérification en cours");
    expect(launchView).toContain("Préparation du guidage");
    expect(launchView).toContain("Lecture du bloc");
    expect(launchView).toContain("Construction du prochain geste");
    expect(launchView).toContain("Guidage IA indisponible");
    expect(launchView).toContain("Réessayer");
    expect(launchView).toContain("Découvrir Premium");
    expect(launchView).toContain("Démarrer en standard");
    expect(launchView).not.toContain("Plan prêt");
    expect(launchView).toContain("Session standard");
    expect(launchView).toContain("Préparer avec l’IA");
    expect(launchView).not.toContain("Mode guidé");
